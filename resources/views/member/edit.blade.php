        ...
        <div class="container col-lg-9" style="background-color: #eceeee">
            ...
            <form  method="post" action="{{ route('member.update',['member'=>$member]) }}" enctype="multipart/form-data">
                <div class="form-group">
                    <label>店铺名称</label>
                    <input type="text" class="form-control" placeholder="商户名" name="shop_name" value="{{ $member->member_info->shop_name }}">
                </div>

                <div class="form-group">
                    <label>店主姓名</label>
                    <input class="form-control" name="name" placeholder="商户姓名" value="{{ $member->name }}" />
                </div>
                ...
                <div class="form-group">
                    <label>邮箱</label>
                    <input type="email" class="form-control" name="email" placeholder="邮箱" value="{{$member->email}}">
                </div>
                ...
                <div class="form-group">
                    <label>评分</label>
                    <input type="number" name="shop_rating"  value="{{ $member->member_info->shop_rating }}">
                </div>
                ...
                <div class="form-group">
                    <label>起送金额</label>
                    <input type="text" name="start_send" class="form-control" value="{{ $member->member_info->start_send }}">
                </div>

                <div class="form-group">
                    <label>配送费</label>
                    <input type="text" name="send_cost" class="form-control" value="{{ $member->member_info->send_cost }}">
                </div>

                <div class="form-group">
                    <label>配送距离</label>
                    <input type="text" name="distance" class="form-control" value="{{ $member->member_info->distance }}">
                </div>

                <div class="form-group">
                    <label>预计时间</label>
                    <input type="text" name="estimate_time" class="form-control" value="{{ $member->member_info->estimate_time }}">
                </div>

                <div class="form-group">
                    <label>店铺公告</label>
                    <textarea name="notice" maxlength="50" class="form-control" rows="3" placeholder="新店开张，优惠大酬宾！">{{ $member->member_info->notice }}</textarea>
                </div>

                <div class="form-group">
                    <label>优惠信息</label>
                    <textarea name="discount" class="form-control" rows="3" placeholder="新用户有巨额优惠" maxlength="50">{{ $member->member_info->discount }}</textarea>
                </div>
                <div class="form-group">

            ...
            <ul class="nav navbar-nav">
                ...
                {{--<li class="dropdown">--}}
                    ...
                    {{--<ul class="dropdown-menu">--}}
                        {{--<li><a href="{{route('members.index') }}">查看用户</a></li>--}}
                        {{--<li role="separator" class="divider"></li>--}}
                        {{--<li><a href="{{ route('members.create') }}">添加用户</a></li>--}}
                    {{--</ul>--}}
                {{--</li>--}}
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ route('category.create') }}">添加商户分类</a></li>
                        <li><a href="{{ route('category.index') }}">查看商户分类</a></li>
                    </ul>
                </li>
            </ul>
